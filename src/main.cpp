...
const string strMessageMagic = "BULLY Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BULLY
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // BULLY: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BULLY", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BULLY Genesis Block";
        CTransaction txNew;
        txNew.nTime = 1484084992;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1484084992;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2063613; // !fTestNet ? 1575379 : 46534;
	
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x2721be26e7c2356b63a7a81c5ef2baab0566c0b60adf30e067699fdf2724e0d8"));
...
unsigned char pchMessageStart[4] = { 0xe4, 0xa8, 0xbb, 0xe5 };
